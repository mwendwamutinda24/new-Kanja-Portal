...
<div class="result1">
    ...
    <table>
        ...
        if ($term && $year) {
            ...
            $sql = "SELECT * FROM fee WHERE grade = 5 AND term = '$term' AND year = '$year'";
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo "<tr><td colspan='9' style='text-align:center; color:red;'>No records found for Grade 5 in $term, $year.</td></tr>";
            }
        } else {
