...
<div class="result1">
    ...
    <table>
        ...
        if ($term && $year) {
            ...
            $sql = "SELECT  DISTINCT* FROM fee WHERE grade = 9 AND term = '$term' AND year = '$year'";
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo "<tr><td colspan='9' style='text-align:center; color:red;'>No records found for Grade 7 in $term, $year.</td></tr>";
            }
        } else {
