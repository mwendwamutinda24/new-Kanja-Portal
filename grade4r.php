    ...
    <div class="results1">
            ...
            <form method="POST" action="upload.php">
                  <table>
                    ...
                    <div class="se">
                       ...
                       <h4 class='term'>SELECT EXAM TYPE</h4>
                              <select name='examType' required class='select'>
                                  	<option value="" required>--select Exam type--</option>
                      ...
                      include 'conn.php';
                      $sql = "SELECT  DISTINCT* FROM Student WHERE Grade = 4";
                        ...
                        echo "
                          <tr>
                             <td><input type='text' name='assesment[]' value='{$row['Assement']}'></td>
                              ...
                              <td><input type='text' name='S/ST[]'class='input2'></td>
                              <td><input type='text' name='SCIE[]'class='input2'></td>
                              <td><input type='text' name='C/A[]'class='input2'></td>
                    ...
                    <label>INPUT THE GRADE YOU ARE APLOADING RESULTS FOR IN HERE IN NUMERICS ONLY</label>
                   <input type='text' name='grade'class='input2'><br>
                    <h1>GRDAE 4 RESULTS UPLOAD</h1>
                  <button class="btn4">Add Marks</button>
               </form>
               </div>
